...
public class Bullet {
     ...
     * Конструктор - снаряд
     *
     * @param x - расположение по х
     * @param y - расположение по y
     * @param destx - расположение по x цели
     * @param desty - расположение по y цели
     * @param dmg - урон
     * @param pict - текстура для отрисовки
     *
     */
     ...
     * @param x - расположение по х
     * @param y - расположение по y
     * @param target - цель в которую летит снаряд
     * @param dmg - урон
     * @param pict - текстура для отрисовки
     *
     */
