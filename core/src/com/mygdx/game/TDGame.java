...
public class TDGame extends Game {
	...
	public void create () {
          ...
          TestMap._roadCell.add(1,new Cell(1,0));
          TestMap._roadCell.add(2,new Cell(2,0));
          TestMap._roadCell.add(3,new Cell(2,1));
          
          TestMap._defenseConst.add(new ArcherTower(new Cell(0,1)));
          TestMap._defenseConst.add(new IceTower(new Cell(3,2)));
          TestMap._defenseConst.add(new LightTower(new Cell(1,2)));
